...
func (com *Dmsoft) DmGuard(enable int, types string) int {
	ret, _ := com.dm.I调用方法("DmGuard", enable, types)
	return int(ret.Val)
}
...
func (com *Dmsoft) DmGuardExtract(types, path string) int {
	ret, _ := com.dm.I调用方法("DmGuardExtract", types, path)
	return int(ret.Val)
}
...
func (com *Dmsoft) UnLoadDriver() int {
	ret, _ := com.dm.I调用方法("UnLoadDriver")
	return int(ret.Val)
}
