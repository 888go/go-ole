...
func (com *LwSoft) SetDict(index int, file, pwd string) int {
	var ret, _ = com.lw.I调用方法("SetDict", index, file, pwd)
	return int(ret.Val)
}
...
func (com *LwSoft) UseDict(index int) int {
	var ret, _ = com.lw.I调用方法("SetDict", index)
	return int(ret.Val)
}
...
func (com *LwSoft) Ocr(x1, y1, x2, y2 int, color_format string, sim float32, linesign string, isbackcolor int) string {
	var ret, _ = com.lw.I调用方法("Ocr", x1, y1, x2, y2, color_format, sim, linesign, isbackcolor)
	return ret.I取文本()
}
...
func (com *LwSoft) FindStr(x1, y1, x2, y2 int, string, color_format string, sim float32, isbackcolor int) int {
	var ret, _ = com.lw.I调用方法("FindStr", x1, y1, x2, y2, string, color_format, sim, isbackcolor)
	return int(ret.Val)
}
