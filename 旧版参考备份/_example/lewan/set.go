...
func (com *LwSoft) BindWindow(hwnd, display, mouse, keypad, added, mode int) int {
	var ret, _ = com.lw.I调用方法("BindWindow", hwnd, display, mouse, keypad, added, mode)
	return int(ret.Val)
}
...
func (com *LwSoft) UnBindWindow() int {
	var ret, _ = com.lw.I调用方法("UnBindWindow")
	return int(ret.Val)
}
...
func (com *LwSoft) ForceUnBindWindow(hwnd int) int {
	var ret, _ = com.lw.I调用方法("ForceUnBindWindow", hwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) SetDisplayInput(mode int) int {
	var ret, _ = com.lw.I调用方法("SetDisplayInput", mode)
	return int(ret.Val)
}
...
func (com *LwSoft) GetBindWindow() int {
	var ret, _ = com.lw.I调用方法("GetBindWindow")
	return int(ret.Val)
}
...
func (com *LwSoft) SwitchBindWindow(hwnd int) int {
	var ret, _ = com.lw.I调用方法("SwitchBindWindow", hwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) LockInput(lock int) int {
	var ret, _ = com.lw.I调用方法("LockInput", lock)
	return int(ret.Val)
}
...
func (com *LwSoft) DownCpu(rate int) int {
	var ret, _ = com.lw.I调用方法("DownCpu", rate)
	return int(ret.Val)
}
...
func (com *LwSoft) LockMove(lock int) int {
	var ret, _ = com.lw.I调用方法("LockMove", lock)
	return int(ret.Val)
}
...
func (com *LwSoft) LockSize(lock int) int {
	var ret, _ = com.lw.I调用方法("LockSize", lock)
	return int(ret.Val)
}
...
func (com *LwSoft) OpenSynscreenshot(isOpen int) int {
	var ret, _ = com.lw.I调用方法("OpenSynscreenshot", isOpen)
	return int(ret.Val)
}
...
func (com *LwSoft) OpenViolentRedraw(isOpen int) int {
	var ret, _ = com.lw.I调用方法("OpenViolentRedraw", isOpen)
	return int(ret.Val)
}
...
func (com *LwSoft) EnableSwitchWindow(flag int) int {
	var ret, _ = com.lw.I调用方法("EnableSwitchWindow", flag)
	return int(ret.Val)
}
...
func (com *LwSoft) IsBind(hwnd int) int {
	var ret, _ = com.lw.I调用方法("IsBind", hwnd)
	return int(ret.Val)
}
