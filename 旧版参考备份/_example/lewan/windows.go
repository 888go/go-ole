...
func (com *LwSoft) FindWindow(title, class, processname string, pid, fhwnd, isvisble, fpid, exacttitle, w, h, lose int, comd string, exactcomd int) int {
	var ret, _ = com.lw.I调用方法("FindWindow", title, class, processname, pid, fhwnd, isvisble, fpid, exacttitle, w, h, lose, comd, exactcomd)
	return int(ret.Val)
}
...
func (com *LwSoft) FindSonWindow(fhwnd int, title, class string) int {
	var ret, _ = com.lw.I调用方法("FindSonWindow", fhwnd, title, class)
	return int(ret.Val)
}
...
func (com *LwSoft) GetSonWindow(fhwnd, var_ int) int {
	var ret, _ = com.lw.I调用方法("GetSonWindow", fhwnd, var_)
	return int(ret.Val)
}
...
func (com *LwSoft) EnumWindow(title, class, processname string, pid, fhwnd, isvisble, exacttitle int) string {
	var ret, _ = com.lw.I调用方法("EnumWindow", title, class, processname, pid, fhwnd, isvisble, exacttitle)
	return ret.I取文本()
}
...
func (com *LwSoft) GetWindowById(fhwnd, id int) int {
	var ret, _ = com.lw.I调用方法("GetWindowById", fhwnd, id)
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindow(hwnd, flag int) int {
	var ret, _ = com.lw.I调用方法("GetWindow", hwnd, flag)
	return int(ret.Val)
}
...
func (com *LwSoft) GetPointWindow(x, y int) int {
	var ret, _ = com.lw.I调用方法("GetPointWindow", x, y)
	return int(ret.Val)
}
...
func (com *LwSoft) GetMousePointWindow() int {
	var ret, _ = com.lw.I调用方法("GetMousePointWindow")
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindowProcessId(hwnd int) int {
	var ret, _ = com.lw.I调用方法("GetWindowProcessId", hwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindowSize(hwnd int) int {
	var ret, _ = com.lw.I调用方法("GetWindowSize", hwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) GetClientSize(hwnd int) int {
	var ret, _ = com.lw.I调用方法("GetClientSize", hwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindowVertex(hwnd int) int {
	var ret, _ = com.lw.I调用方法("GetWindowVertex", hwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindowState(hwnd, flag int) int {
	var ret, _ = com.lw.I调用方法("GetWindowState", hwnd, flag)
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindowTitle(hwnd, flag int) string {
	var ret, _ = com.lw.I调用方法("GetWindowTitle", hwnd, flag)
	return ret.I取文本()
}
...
func (com *LwSoft) GetWindowClass(hwnd int) string {
	var ret, _ = com.lw.I调用方法("GetWindowClass", hwnd)
	return ret.I取文本()
}
...
func (com *LwSoft) GetWindowProcessPath(hwnd int) string {
	var ret, _ = com.lw.I调用方法("GetWindowProcessPath", hwnd)
	return ret.I取文本()
}
...
func (com *LwSoft) ScreenToClient(hwnd, x, y int) int {
	var ret, _ = com.lw.I调用方法("ScreenToClient", hwnd, x, y)
	return int(ret.Val)
}
...
func (com *LwSoft) ClientToScreen(hwnd, x, y int) int {
	var ret, _ = com.lw.I调用方法("ClientToScreen", hwnd, x, y)
	return int(ret.Val)
}
...
func (com *LwSoft) SetWindowText(hwnd int, title string) int {
	var ret, _ = com.lw.I调用方法("SetWindowText", hwnd, title)
	return int(ret.Val)
}
...
func (com *LwSoft) MoveWindow(hwnd, x, y, width, height int) int {
	var ret, _ = com.lw.I调用方法("MoveWindow", hwnd, x, y, width, height)
	return int(ret.Val)
}
...
func (com *LwSoft) SetWindowSize(hwnd, width, height int) int {
	var ret, _ = com.lw.I调用方法("SetWindowSize", hwnd, width, height)
	return int(ret.Val)
}
...
func (com *LwSoft) SetWindowState(hwnd, flag int) int {
	var ret, _ = com.lw.I调用方法("SetWindowState", hwnd, flag)
	return int(ret.Val)
}
...
func (com *LwSoft) SetWindowTransparent(hwnd, trans int) int {
	var ret, _ = com.lw.I调用方法("SetWindowTransparent", hwnd, trans)
	return int(ret.Val)
}
...
func (com *LwSoft) SetWindowBorder(hwnd, flag int) int {
	var ret, _ = com.lw.I调用方法("SetWindowBorder", hwnd, flag)
	return int(ret.Val)
}
...
func (com *LwSoft) SetParent(shwnd, fhwnd int) int {
	var ret, _ = com.lw.I调用方法("SetParent", shwnd, fhwnd)
	return int(ret.Val)
}
...
func (com *LwSoft) SetWindowFlag(hwnd, flag int) int {
	var ret, _ = com.lw.I调用方法("SetWindowFlag", hwnd, flag)
	return int(ret.Val)
}
...
func (com *LwSoft) GetWindowFlag(hwnd int) int {
	var ret, _ = com.lw.I调用方法("SetWindowFlag", hwnd)
	return int(ret.Val)
}
