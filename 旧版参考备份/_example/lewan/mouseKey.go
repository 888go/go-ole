...
func (com *LwSoft) SetRandomDelay(delay int) int {
	var ret, _ = com.lw.I调用方法("SetRandomDelay", delay)
	return int(ret.Val)
}
...
func (com *LwSoft) EnableKeyMouseSync(mode int) int {
	var ret, _ = com.lw.I调用方法("EnableKeyMouseSync", mode)
	return int(ret.Val)
}
...
func (com *LwSoft) SetSimMode(mode int) int {
	var ret, _ = com.lw.I调用方法("SetSimMode", mode)
	return int(ret.Val)
}
...
func (com *LwSoft) SetKeypadDelay(delay int) int {
	var ret, _ = com.lw.I调用方法("SetKeypadDelay", delay)
	return int(ret.Val)
}
...
func (com *LwSoft) SetMouseDelay(delay int) int {
	var ret, _ = com.lw.I调用方法("SetMouseDelay", delay)
	return int(ret.Val)
}
...
func (com *LwSoft) EnableRealMouse(enable, mousedelay, mousestep int) int {
	var ret, _ = com.lw.I调用方法("EnableRealMouse", enable, mousedelay, mousestep)
	return int(ret.Val)
}
...
func (com *LwSoft) KeyPress(vk_code, num int) int {
	var ret, _ = com.lw.I调用方法("KeyPress", vk_code, num)
	return int(ret.Val)
}
...
func (com *LwSoft) KeyPressEx(vk_code, StateKey int) int {
	var ret, _ = com.lw.I调用方法("KeyPressEx", vk_code, StateKey)
	return int(ret.Val)
}
...
func (com *LwSoft) KeyDown(vk_code int) int {
	var ret, _ = com.lw.I调用方法("KeyDown", vk_code)
	return int(ret.Val)
}
...
func (com *LwSoft) KeyUp(vk_code int) int {
	var ret, _ = com.lw.I调用方法("KeyUp", vk_code)
	return int(ret.Val)
}
...
func (com *LwSoft) KeyPressStr(key_str string, delay int) int {
	var ret, _ = com.lw.I调用方法("KeyPressStr", key_str, delay)
	return int(ret.Val)
}
...
func (com *LwSoft) LeftClick() int {
	var ret, _ = com.lw.I调用方法("LeftClick")
	return int(ret.Val)
}
...
func (com *LwSoft) LeftDoubleClick() int {
	var ret, _ = com.lw.I调用方法("LeftDoubleClick")
	return int(ret.Val)
}
...
func (com *LwSoft) LeftDown() int {
	var ret, _ = com.lw.I调用方法("LeftDown")
	return int(ret.Val)
}
...
func (com *LwSoft) MoveR(rx, ry int) int {
	var ret, _ = com.lw.I调用方法("MoveR", rx, ry)
	return int(ret.Val)
}
...
func (com *LwSoft) MoveToEx(x, y, w, h int) string {
	var ret, _ = com.lw.I调用方法("MoveToEx", x, y, w, h)
	return ret.I取文本()
}
...
func (com *LwSoft) MoveTo(x, y int) int {
	var ret, _ = com.lw.I调用方法("MoveTo", x, y)
	return int(ret.Val)
}
...
func (com *LwSoft) RightClick() int {
	var ret, _ = com.lw.I调用方法("RightClick")
	return int(ret.Val)
}
...
func (com *LwSoft) RightDown() int {
	var ret, _ = com.lw.I调用方法("RightDown")
	return int(ret.Val)
}
...
func (com *LwSoft) RightUp() int {
	var ret, _ = com.lw.I调用方法("RightUp")
	return int(ret.Val)
}
...
func (com *LwSoft) MiddleClick() int {
	var ret, _ = com.lw.I调用方法("MiddleClick")
	return int(ret.Val)
}
...
func (com *LwSoft) WheelDown() int {
	var ret, _ = com.lw.I调用方法("WheelDown")
	return int(ret.Val)
}
...
func (com *LwSoft) WheelUp() int {
	var ret, _ = com.lw.I调用方法("WheelUp")
	return int(ret.Val)
}
...
func (com *LwSoft) GetCursorShape(mod int) int {
	var ret, _ = com.lw.I调用方法("GetCursorShape", mod)
	return int(ret.Val)
}
...
func (com *LwSoft) GetKeyState(key int) int {
	var ret, _ = com.lw.I调用方法("GetKeyState", key)
	return int(ret.Val)
}
...
func (com *LwSoft) WaitKey(vk_code, time_out int) int {
	var ret, _ = com.lw.I调用方法("WaitKey", vk_code, time_out)
	return int(ret.Val)
}
...
func (com *LwSoft) SendString(str string, mod, hwnd int) int {
	var ret, _ = com.lw.I调用方法("SendString", str, mod, hwnd)
	return int(ret.Val)
}
